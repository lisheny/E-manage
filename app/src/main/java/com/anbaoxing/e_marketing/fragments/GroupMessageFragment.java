...
import com.anbaoxing.e_marketing.widget.MessageRecyclerviewAdapter;
...
public class GroupMessageFragment extends BaseFragment {
    ...
    private void initView(){
        ...
        adapter = new MessageRecyclerviewAdapter(mContext, mTestDatas);
        messageFragmentRecyclerview.setLayoutManager(new LinearLayoutManager(mContext));
        messageFragmentRecyclerview.setAdapter(adapter);
        adapter.setOnItemClickLitener(new MessageRecyclerviewAdapter.OnItemClickLitener() {
            @Override
